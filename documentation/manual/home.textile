...
With this module, you'll be able to easily deploy and manage your play applications on Red Hat's cloud platform, with just a couple of simple commands from the command line.
...
* "install play":[http://www.playframework.org/documentation/latest/install]

* "sign up for openshift":[https://openshift.redhat.com/app/user/new/express]

* "install openshift's command line tools":[https://www.redhat.com/openshift/community/kb/kb-e1000/installing-openshift-express-client-tools-on-non-rpm-based-systems].
...
The module will create your app at openshift if it's not already there, compile and package your app as a war folder, commit it in yout local git repository and then push it to openshift. Moreover, you can add the @-o@ parameter to have the module automatically open your newly deployed app in a web browser.
...
First of all, it's a good moment to check that you have fullfilled all the prerequisites. So issue:
